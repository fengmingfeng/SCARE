...
def create_dataset(dataset, config):
    ...
    if dataset=='pretrain':
        ...
        vqa_val_dataset=vqa_dataset(config['val_file'], test_transform, config['vqa_root'], config['vg_root'], split='test', answer_list=config['answer_list'])
        return train_dataset, vqa_test_dataset,vqa_val_dataset
